...
> **OpenAI API와 HIRA 공공데이터를 활용한<br>
> Spring Boot 기반 AI Healthcare Backend Project**
...
![HIRA API](https://img.shields.io/badge/HIRA-Open_API-555555)
...
회원 정보와 병원 정보, 즐겨찾기 및 AI 분석 이력처럼 관계가 명확한
...
- React 화면 구현 및 Backend API 연동
- OpenAI API 및 HIRA Open API 연동
- Docker 기반 실행 환경 구성 및 배포
...
- Docker Hub를 활용하여 이미지를 배포하고 EC2에서 Pull 방식으로 실행하도록 구성
- Docker Compose로 Spring Boot와 MySQL 컨테이너 환경을 구성하고, Docker Hub에 이미지를 등록한 후 AWS EC2에서 배포 과정 진행
